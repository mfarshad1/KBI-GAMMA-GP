...
for sys in range(len(system)):
    ...
    if system[sys] == "C":
        axes_all[0].errorbar(x2[1:len(x1)], KBI_1_1_all_corrected, yerr=KBI_1_1_all_corrected_error, fmt='o-', color=colors[0], markersize=8, fillstyle='none', label=r'$\xi = 0.85$')
        axes_all[1].errorbar(x2[1:len(x1)-1], KBI_1_2_all_corrected, yerr=KBI_1_2_all_corrected_error, fmt='o-', color=colors[0], markersize=8, fillstyle='none', label=r'$\xi = 0.85$')
        axes_all[2].errorbar(x2[0:len(x1)-1], KBI_2_2_all_corrected, yerr=KBI_2_2_all_corrected_error, fmt='o-', color=colors[0], markersize=8, fillstyle='none', label=r'$\xi = 0.85$')

    if system[sys] == "A":
        axes_all[0].errorbar(x2[1:len(x1)], KBI_1_1_all_corrected, yerr=KBI_1_1_all_corrected_error, fmt='o-', color=colors[1], markersize=8, fillstyle='none', label=r'$\xi = 1$')
        axes_all[1].errorbar(x2[1:len(x1)-1], KBI_1_2_all_corrected, yerr=KBI_1_2_all_corrected_error, fmt='o-', color=colors[1], markersize=8, fillstyle='none', label=r'$\xi = 1$')
        axes_all[2].errorbar(x2[0:len(x1)-1], KBI_2_2_all_corrected, yerr=KBI_2_2_all_corrected_error, fmt='o-', color=colors[1], markersize=8, fillstyle='none', label=r'$\xi = 1$')
        
    if system[sys] == "B":
        axes_all[0].errorbar(x2[1:len(x1)], KBI_1_1_all_corrected, yerr=KBI_1_1_all_corrected_error, fmt='o-', color=colors[2], markersize=8, fillstyle='none', label=r'$\xi = 1.2$')
        axes_all[1].errorbar(x2[1:len(x1)-1], KBI_1_2_all_corrected, yerr=KBI_1_2_all_corrected_error, fmt='o-', color=colors[2], markersize=8, fillstyle='none', label=r'$\xi = 1.2$')
        axes_all[2].errorbar(x2[0:len(x1)-1], KBI_2_2_all_corrected, yerr=KBI_2_2_all_corrected_error, fmt='o-', color=colors[2], markersize=8, fillstyle='none', label=r'$\xi = 1.2$')
