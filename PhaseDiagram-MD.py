...
pp = PdfPages('density_phase_A3.pdf')
...
for n in range(points):
    ...
    density = "/scratch365/mfarshad/gpr/md/systemA/lj_new3/x1="+str(mf)+"/density_1.T-0.77.data"
    ...
    if mf not in ["0.0", "1.0"]:
        print('den2 =',mf)
        density = "/scratch365/mfarshad/gpr/md/systemA/lj_new3/x1="+str(mf)+"/density_2.T-0.77.data"
    all_density = []  # empty lists for each column
...
for n in range(points):
    ...
    #read in the file line by line
    pressure = "/scratch365/mfarshad/gpr/md/systemA/lj_new3/x1="+str(mf)+"/pzz.txt"
