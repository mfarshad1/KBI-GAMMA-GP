...
correction = 0
if correction==10:
    pp1 = PdfPages('RDF+KBI-corrected_B_new.pdf')
if correction==0:
    pp1 = PdfPages('RDF+KBI_B_new.pdf')
...
x1 = [0.0, 0.103647724,0.248293855,0.391093871,0.472206501,0.582965203,
      0.69269479,0.786360776,0.879746995, 1.0]
...
for n in range(points):
    ...
    rdf_file = "/scratch365/mfarshad/gpr/md/systemB/lj_cube1/x1="+str(mf)+"/rdf.data"
...
correction = 0
if correction==1:
    pp = PdfPages('KBI-corrected_B.pdf')
if correction==0:
    pp = PdfPages('KBI_B.pdf')
