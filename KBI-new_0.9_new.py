...
correction = 0
if correction==10:
    pp1 = PdfPages('RDF+KBI-corrected_0.9_new.pdf')
if correction==0:
    pp1 = PdfPages('RDF+KBI_0.9_new.pdf')
...
for n in range(points):
    ...
    rdf_file = "/scratch365/mfarshad/gpr/md/system_0.9/lj_cube2/x1="+str(mf)+"/rdf.data"
...
correction = 0
if correction==1:
    pp = PdfPages('KBI-corrected_0.9.pdf')
if correction==0:
    pp = PdfPages('KBI_0.9.pdf')
