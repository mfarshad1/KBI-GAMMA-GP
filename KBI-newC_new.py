...
correction = 0
if correction==10:
    pp1 = PdfPages('RDF+KBI-corrected_C_new.pdf')
if correction==0:
    pp1 = PdfPages('RDF+KBI_C_new.pdf')
...
x1 = [0.0,0.041957881,0.083981191,0.122780343,0.320946777,0.635060225,
      0.740312959,0.828679361,0.908626271,1.0]
...
for n in range(points):
    ...
    rdf_file = "/scratch365/mfarshad/gpr/md/systemC/lj_cube1/x1="+str(mf)+"/rdf.data"
...
correction = 0
if correction==1:
    pp = PdfPages('KBI-corrected_C.pdf')
if correction==0:
    pp = PdfPages('KBI_C.pdf')
